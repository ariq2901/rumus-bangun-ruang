...
<head>
  ...
  <title>Calculator Bola</title>
</head>
<body>
  <div class="container">
    <div class="row h-100 justify-content-center mt-5">
      <div class="col col-6">
        <form action="/rumus-bola" method="post">
          @csrf
          <div class="form-group">
            <input type="text" class="neu form-control @error('jari2') is-invalid @enderror" id="jari2" name="jari2" placeholder="jari-jari" autocomplete="off" value={{ old('jari2') }}>
            @error('jari2')
